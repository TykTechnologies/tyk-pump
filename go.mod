...
require (
	...
	github.com/TykTechnologies/tyk v0.0.0-20191009120558-baa77a9d0401
	github.com/TykTechnologies/tykcommon-logger v0.0.0-20161201171151-7bae07354eba
	...
	gopkg.in/olivere/elastic.v6 v6.2.24
