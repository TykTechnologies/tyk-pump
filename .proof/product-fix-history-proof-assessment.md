...
- `REVIEW-140ef71-sql-aggregate-sharded-upsert`, `REVIEW-0596e82-syslog-fragmentation`, `REVIEW-5965206-50e5f51-kinesis-kms`, `REVIEW-0ed84b9-mongo-graph-inclusion`, `REVIEW-1fd5ba9-mongo-collection-targets`, `REVIEW-7fa0754-graph-sql-aggregate-shard-target`, and `REVIEW-fbcb614-sql-empty-shard-batch` preserve split/superseded fix history, active KI debt, or caught-regression reasoning where one commit introduced, superseded, or validated behavior later pinned by a DEFECT or requirement.
