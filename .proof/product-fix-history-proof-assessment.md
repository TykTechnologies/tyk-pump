...
| c02a2cb | 2019-07-16 | HTTP 400 was not counted as an error in aggregates. | `covered_after_hardening`: SW-REQ-103 now pins the REST aggregate HTTP error boundary (`ResponseCode >= 400`) with DEFECT-45 and a 399/400/500 boundary regression test. DEFECT-45 records proposed signal shape `go.aggregate-http-error-threshold-strict-greater-than`; no committed signal artifact exists yet. |
