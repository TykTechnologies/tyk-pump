...
| 35e1e74 | 2024-01-04 | TT-10564 Splunk backoff retry | `missed_before_hardening`: added `request_body_replay_preserved`, explicit body-replay obligation evidence for the shared retry helper, Splunk `retry_policy_explicit` evidence for MaxRetries behavior, and review `REVIEW-35e1e74-splunk-retry`. |
