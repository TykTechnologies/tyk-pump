...
| 416d1c7 | 2020-05-26 | fixing b64 decoding | `covered_after_hardening`: same defect class as 0adb849 and covered by DEFECT-36: successful Elasticsearch `decode_base64` mapping is specified and witnessed as decoded text, with the malformed-input gap tracked separately as KI `elasticsearch-decode-base64-errors-silent-empty`. |
